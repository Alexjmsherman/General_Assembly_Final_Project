...
h1
str(h1.text) # Print out just the text inside of the body
...
l = b.find('li', attrs={'id':'my favorite'})
l['id']
...
title # Prints HTML matching thattag, but we want the actual name
str(title.text) # The "text" attribute gives you the text between two HTML tags

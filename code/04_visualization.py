...
drinks = pd.read_table(r'https://raw.githubusercontent.com/justmarkham/DAT5/master/data/drinks.csv', sep=',')
...
ax = drinks.plot(kind='scatter', x='beer_servings', y='wine_servings', alpha=0.6, color = 'DarkBlue', label='Group1')
drinks.plot(kind='scatter', x='beer_servings', y='spirit_servings', alpha=0.6, color = 'DarkGreen', label='Group2', ax=ax)
plt.show()
...
plt.title("liters of pure alcohol by continent")
plt.xlabel('continent')
